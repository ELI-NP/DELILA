...
class Dispatcher : public DAQMW::DaqComponentBase
{
 public:
 ...
 private:
  ...
  TimedOctetSeq m_in5_data;
  InPort<TimedOctetSeq> m_InPort5;

  TimedOctetSeq m_in6_data;
  InPort<TimedOctetSeq> m_InPort6;

  TimedOctetSeq m_in7_data;
  InPort<TimedOctetSeq> m_InPort7;
 ...
 private:
  ...
  BufferStatus m_in5_status;
  BufferStatus m_in6_status;
  BufferStatus m_in7_status;
  ...
  unsigned int m_in4_timeout_counter;   //timeout counter for InPort reading
  unsigned int m_in5_timeout_counter;   //timeout counter for InPort reading
  unsigned int m_in6_timeout_counter;   //timeout counter for InPort reading
  unsigned int m_in7_timeout_counter;   //timeout counter for InPort reading
